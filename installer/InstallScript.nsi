...
; The name of the installer
  Name "OCTGN Deck Converter v3.1.0"

; The file to write
  OutFile "OCTGNDeckConverterInstaller v3.1.0.exe"
...
;Pages
  ...
  !define MUI_TEXT_WELCOME_INFO_TEXT "This wizard will install the OCTGN Deck Converter plugin v3.1.0 for OCTGN.$\n$\nClick Install to start the installation."
