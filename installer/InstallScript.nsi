...
; The name of the installer
  Name "OCTGN Deck Converter v3.0.0 Beta1"

; The file to write
  OutFile "OCTGNDeckConverterInstaller v3.0.0 Beta1.exe"
...
;Pages
  ...
  !define MUI_TEXT_WELCOME_INFO_TEXT "This wizard will install the OCTGN Deck Converter plugin v3.0.0 (Beta 1) for OCTGN.$\n$\nClick Install to start the installation."
