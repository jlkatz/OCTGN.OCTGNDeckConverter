...
; The name of the installer
  Name "OCTGN Deck Converter v3.3.6 (Development Build)"
...
;Pages
  ...
  !define MUI_TEXT_WELCOME_INFO_TEXT "This wizard will install the OCTGN Deck Converter plugin v3.3.6 (Development Build) for OCTGN.$\n$\nClick Install to start the installation."
